...
ref          = "WILMS-5B"
page         = 16
title        = "Footnote conditions governing the unilateral FHWT initially unresectable pathway: biomarkers, regimen switch, surgery timing, and RT fields"
nccn_version = "1.2026"
nccn_date    = "05/04/2026"
generated    = "2026-08-28"
see_also     = ["WILMS-5", "WILMS-5A", "WILMS-C", "WILMS-D", "WILMS-G", "WILMS-H", "ST-1"]
...
type = "enum"
options = ["CR", "incomplete response"]
[[variables]]
name = "chemo_week"
type = "number"
+++
...
- This page is the footnote set for the treatment pathway diagram; each item below is the condition attached to a step of that pathway
...
# Chemotherapy regimen decisions

- Switch to Regimen M (preferred) at week 7 if either condition holds
...
- Extrapulmonary metastases
    ...
    - 4-year EFS was 76% for Regimen M on AREN0533 compared to 65% for patients treated with DD4A on NWTS-5 (P = .26)
...
- Tumors should be resected by 12 weeks at the latest (total nephrectomy), because continued significant tumor shrinkage was not seen after this point in treatment
- If imaging shows tumor progression (increase in size), perform nephrectomy OR rebiopsy
