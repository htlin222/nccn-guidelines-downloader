...
- Risks associated with each agent vary significantly
    ...
    - Refer to appropriate clinical trial protocols for the same
- All recommendations are category 2A unless otherwise indicated

# Assessment

- Lymphocyte engager given: ___ (agent)
- Route ___ (route)
- CRS grade for this event ___ (crs_grade)
- Administration of the current dose already completed ___ (dose_completed)
- First occurrence or recurrent CRS ___ (occurrence)
- Duration of the CRS event ___ (crs_duration)
- Time since CRS resolved ___ (time_since_resolution)

# All agents, grade 4

- Grade 4: permanently discontinue bispecific therapy

# Glofitamab-gxbm IV and mosunetuzumab-axgb IV
...
- Next dose
    ...
    - Grade 2 & 3: CRS resolved; hospitalize for at minimum 22 hours for next dose
...
- CRS workup, grading, and management of grade 1 and grade 2 CRS, see ENGAGE-3
- Re-challenge after ICANS rather than after CRS, see ENGAGE-8
