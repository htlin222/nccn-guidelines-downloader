...
- This page defines regional lymph nodes (N), clinical N (cN) only
...
- Clinically overt extranodal extension (ENE): ___ (ene)
- cN category assigned: ___ (n_category)
- U or L designation, relative to the lower border of the cricoid: ___ (ul_designation)
