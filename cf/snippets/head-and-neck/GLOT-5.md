+++
id           = "head-and-neck/GLOT-5"
gid          = "head-and-neck"
ref          = "GLOT-5"
page         = 48
title        = "Response assessment after induction chemotherapy for glottic larynx cancer, and adjuvant treatment"
nccn_version = "2.2026"
nccn_date    = "05/12/2026"
generated    = "2026-08-28"
see_also     = ["GLOT-4", "GLOT-6", "SURG-A", "SYST-A", "FOLL-A", "ADV-1", "ADV-3"]
...
- NCCN Head and Neck Cancers v2.2026, GLOT-5, p48
- Cancer of the Glottic Larynx
- Applies to response assessment after induction chemotherapy
...
- Nodal disease ___ (nodal_status)
...
# Response: CR at primary site

- Definitive RT (category 1), per Principles of Radiation Therapy (GLOT-A)
- Then Post Systemic Therapy/RT or RT Neck Evaluation (FOLL-A, 2 of 2)

# Response: PR at primary site

- RT (category 1), per Principles of Radiation Therapy (GLOT-A)
- or Systemic therapy/RT (category 2B) (GLOT-A, SYST-A)
- Then Post Systemic Therapy/RT or RT Neck Evaluation (FOLL-A, 2 of 2)
...
- Treatment of very advanced head and neck cancer, go to ADV-1

# Adjuvant treatment after surgery

- No adverse pathologic features
    - RT (GLOT-A)
- Adverse pathologic features, defined as extranodal extension, positive margins, close margins, pT4 primary, pN2 or pN3 nodal disease, perineural invasion, vascular invasion, lymphatic invasion, and subglottic extension (Discussion)
    - Extranodal extension and/or positive margin
        - Systemic therapy/RT (category 1) (GLOT-A, SYST-A)
    - Other risk features
        - RT (GLOT-A)
...
- After definitive RT, RT, or systemic therapy/RT, Post Systemic Therapy/RT or RT Neck Evaluation (FOLL-A, 2 of 2)
