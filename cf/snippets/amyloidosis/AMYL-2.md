...
ref          = "AMYL-2"
page         = 6
title        = "Organ-directed diagnostic workup and the treatment path once organ involvement is established"
nccn_version = "2.2026"
nccn_date    = "03/16/26"
...
- Diagnostic workup: special testing based on organ system involvement
- Frailty assessment should be considered in older adults, for the diagnostic workup and for the treatment of newly diagnosed SLCA, see NCCN Guidelines for Older Adult Oncology
...
- Organ involvement present based on amyloidosis consensus criteria: ___ (consensus_criteria_met)
...
- If there is organ involvement based on amyloidosis consensus criteria (AMYL-C), go to treatment of newly diagnosed SLCA
    ...
    - or Therapy for newly diagnosed disease (AMYL-B)
        - Organ transplant, as clinically indicated
