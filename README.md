...
| 🖨 **Print a page** | The current page re-rendered offscreen at 300 DPI, not a grab of the on-screen canvas. Orientation follows the page and it scales to fit one sheet, whatever paper you load. |
